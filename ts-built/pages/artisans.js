...
const FeaturedImage_1 = require("../components/images/artisans/FeaturedImage");
...
const testimonials_artisan_1 = require("../components/testimonials/testimonials-artisan");
        ...
        <div className="lg:grid lg:grid-cols-12">
          <div className="lg:col-span-12 lg:mx-6 md:mx-6 sm:mx-6 mx-6">
            ...
            <section className=" mb-6 pt-3 md:pb-16 relative artisan">
              ...
              <testimonials_artisan_1.default />
            </section>
          </div>
        </div>
      </div>
