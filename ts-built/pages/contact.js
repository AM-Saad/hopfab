...
const map_marker_icon_1 = require("../components/icons/map-marker-icon");
const contact_form_1 = require("../components/forms/contact-form");
const ContactPage = () => (<base_layout_1.default>
