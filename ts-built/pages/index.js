...
const homepage_illustration_1_image_1 = require("../components/images/homepage/homepage-illustration-1-image");
const homepage_event_1_image_1 = require("../components/images/homepage/homepage-event-1-image");
const homepage_event_2_image_1 = require("../components/images/homepage/homepage-event-2-image");
const homepage_blog_post_list_item_1 = require("../components/blog-posts/homepage-blog-post-list-item");
const hopfab_circle_1 = require("../components/hopfab-circle");
const instagram_feed_1 = require("../components/instagram-feed/instagram-feed");
const down_right_arrow_icon_1 = require("../components/icons/down-right-arrow-icon");
const home_projects_1 = require("../components/projects/home-projects");
const animated_btn_1 = require("../components/call-to-actions/animated-btn");
require("../css/home.css");
const IndexPage = ({ data: { stickyPosts, instagramFeed }, }) => {
    var _a;
    const mainStickyBlogPost = (_a = stickyPosts.nodes) === null || _a === void 0 ? void 0 : _a[0];
    const handleScrollToBottom = e => {
        var _a;
        const topElement = (_a = document.getElementsByTagName("footer")) === null || _a === void 0 ? void 0 : _a[0];
    ...
    return (<base_layout_1.default>
          ...
          <div className="pt-22 mb-8">
              ...
              <br /> sur Instagram
                  ...
                  <instagram_feed_1.default slides={instagramFeed.nodes.map(f => ({
            image: f,
            alt: "",
        }))}/>
              </section>
