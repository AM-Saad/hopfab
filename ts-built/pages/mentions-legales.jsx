...
var MentionsLegalesPage = function () {
    var _a = react_1.useState("tab-acheteur"), currentTab = _a[0], setCurrentTab = _a[1];
    return (<default_layout_1.default>
      ...
      <div className="sm:flex sm:flex-col sm:align-center">
        <div className="relative self-center mt-6 bg-gray-100 rounded-lg p-0.5 flex sm:mt-8">
          <button id="button-tab-acheteur" type="button" onClick={function () { return setCurrentTab("tab-acheteur"); }} className={"relative w-1/2 rounded-md py-2 text-sm font-medium text-gray-700 focus:outline-none focus:ring-2 focus:ring-brown-700 focus:z-10 sm:w-auto sm:px-8 " + (currentTab === "tab-acheteur"
          ...
          <button id="button-tab-intermediaire" type="button" onClick={function () { return setCurrentTab("tab-intermediaire"); }} className={"ml-0.5 relative w-1/2 rounded-md py-2 text-sm font-medium text-gray-700 focus:outline-none focus:ring-2 focus:ring-brown-700 focus:z-10 sm:w-auto sm:px-8 " + (currentTab === "tab-intermediaire"
            ? "bg-brown-700 text-brown-50 border-gray-200"
...
//# sourceMappingURL=mentions-legales.jsx.map