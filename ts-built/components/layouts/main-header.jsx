...
var hopfab_logo_1 = require("../icons/hopfab-logo");
var link_with_arrow_1 = require("../link-with-arrow");
var animated_btn_1 = require("../call-to-actions/animated-btn");
var full_logo_white_png_1 = require("../../images/full-logo-white.png");
    ...
    return (<>
          <header className="sticky top-0 w-full z-50">
              ...
              <div className="-mr-2 -my-2 lg:hidden">
                <button onClick={function () { return setIsMobileMenuOpen(true); }} type="button" className="group relative overflow-hidden  inline-flex items-center uppercase bg-black text-xsm font-bold text-white rounded-full border-1.5 border-gray-400 px-6 py-2 md:px-5 focus:outline-none focus:ring-4 focus:ring-brown-700 focus:ring-opacity-50">
                  <span>Menu</span>
                </button>
              </div>
            ...
            <div className="h-full shadow-lg menu-wrapper overflow-scroll">
              <div className="p-5 md:p-7">
                <div className="flex items-center justify-end">
                  <div className="-mr-2">
                    <button onClick={function () { return setIsMobileMenuOpen(false); }} type="button" className="group text-center relative overflow-hidden animated-button uppercase text-xs text-white rounded-full border-1.5 border-gray-200 px-6 py-2 md:px-5 md:py-2 xl:px-4 xl:py-2 focus:outline-none focus:ring-4 focus:ring-brown-700 focus:ring-opacity-50 ">
                      <span>Fermer</span>
                    </button>
                  </div>
                </div>
...
//# sourceMappingURL=main-header.jsx.map