...
const hopfab_circle_1 = require("../hopfab-circle");
const hopfab_circle_white_1 = require("../hopfab-circle_white");
const facebook_icon_1 = require("../icons/facebook-icon");
const instagram_icon_1 = require("../icons/instagram-icon");
const pinterest_icon_1 = require("../icons/pinterest-icon");
const linkedin_icon_1 = require("../icons/linkedin-icon");
const down_right_arrow_icon_1 = require("../icons/down-right-arrow-icon");
const link_with_arrow_1 = require("../link-with-arrow");
const a_with_arrow_1 = require("../a-with-arrow");
const up_arrow_icon_1 = require("../icons/up-arrow-icon");
const newsletter_form_1 = require("../forms/newsletter-form");
const smooth_animation_1 = require("../../utilities/smooth-animation");
const full_logo_2__png_1 = require("../../images/full-logo(2).png");
const full_logo_w_png_1 = require("../../images/full-logo_w.png");
const MainFooter = ({ theme }) => {
    const handleScrollToTop = e => {
        var _a;
        const topElement = (_a = document.getElementsByTagName("body")) === null || _a === void 0 ? void 0 : _a[0];
