...
var material_list_item_1 = require("./material-list-item");
var down_right_arrow_icon_1 = require("../icons/down-right-arrow-icon");
var MaterialList = function (_a) {
    var initialMaterials = _a.initialMaterials, initialCurrentPage = _a.initialCurrentPage, totalPages = _a.totalPages, selectedCategory = _a.selectedCategory;
    var _b = react_1.useState(initialMaterials), materials = _b[0], setMaterials = _b[1];
    ...
    var NUM_COLUMNS = 2;
    var numLines = react_1.useMemo(function () { return Math.ceil(materials.length / NUM_COLUMNS); }, [
        materials,
    ]);
    ...
    var fetchData = react_1.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, http_1.get("/materiautheque" + (selectedCategory ? "-" + selectedCategory : "") + "-" + currentPage + ".json")];
                case 2:
                    result_1 = _a.sent();
                    if (result_1 === {})
                        return [2 /*return*/];
                    setMaterials(function (oldMaterials) { return __spreadArray(__spreadArray([], oldMaterials), result_1.map(function (d) { return d.material; })); });
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
                    return [3 /*break*/, 4];
    ...
    return (<div className="grid grid-cols-1 gap-18">
      {lines.map(function (_, lineIndex) { return (<div key={lineIndex} className="grid grid-cols-1 md:grid-cols-2 gap-x-12 md:gap-x-14 lg:gap-x-18 xl:gap-x-22 2xl:gap-x-24 gap-y-18">
          {materials
                ...
                .map(function (material, rowIndex) { return (<material_list_item_1.default key={material.id} material={material} className={"" + (rowIndex === 0 ? "" : "md:mt-26 lg:mt-30 xl:mt-34")}/>); })}
        </div>); })}
