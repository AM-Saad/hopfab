...
const testimonials_json_1 = require("../content/testimonials.json");
...
const Testimonials = ({ className }) => {
    return (<react_2.Swiper className={className} tag="section" slidesPerView={1} autoHeight={true} loop={true} a11y={{
            ...
            type: "custom",
            renderCustom: (swiper, current, total) => ` <div className="font-bold">
      ...
      {testimonials_json_1.default.map((testimonial, index) => {
            var _a;
