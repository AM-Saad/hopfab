...
var QuotationStepProjectTypology = function () {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <fieldset>
            ...
            <div className="grid sm:grid-cols-3 gap-x-18 mx-auto">
              {state.data.projectTypologies.map(function (projectTypology, index) { return (<div key={projectTypology.code} className="rounded-md -space-y-px">
                  <div className="relative py-4 flex">
                    <div className="flex items-center h-5">
                      <input id={"projectTypologyId-option-" + index} {...register("projectTypologyId", {
            required: "Vous devez sélectionner une option",
        })} type="radio" className="bg-gris-800 h-8 w-8 text-gris-800 cursor-pointer border-brown-50 focus:ring-opacity-50 focus:ring-brown-50 checked:border-brown-50" value={projectTypology.code} defaultChecked={state.form.projectTypologyId === projectTypology.code} onChange={function (e) {
                return actions.updateForm({
                    projectTypologyId: e.target.value,
                });
            }}/>
                    </div>
                    <label htmlFor={"projectTypologyId-option-" + index} className="ml-8 flex flex-col cursor-pointer">
            ...
            {errors.projectTypologyId && (<p className="flex mt-2 text-sm text-red-600" id="projectTypologyId-error">
...
exports.default = QuotationStepProjectTypology;
//# sourceMappingURL=quotation-step-project-typology.jsx.map