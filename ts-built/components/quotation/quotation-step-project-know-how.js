...
const QuotationStepProjectKnowHow = () => {
    ...
    const itemsComponents = () => {
        ...
        })} type="radio" className="bg-gris-800 h-8 w-8 text-gris-800 cursor-pointer border-brown-50 focus:ring-opacity-50 focus:ring-brown-50 checked:border-brown-50" value={profession.code} defaultChecked={state.form.professionId === profession.code} onChange={e => {
