...
var QuotationStepDescription = function () {
    ...
    return (<form onSubmit={handleSubmit(onSubmit)} className="flex-auto h-full flex flex-col">
      <div className="flex-auto pt-16">
        ...
        maxLength: {
            ...
            : "border-red-300 text-red-900 placeholder-red-300 focus:outline-none focus:ring-red-500 focus:border-red-500") + " disabled:opacity-50"} placeholder="" aria-invalid={!!errors.projectName} aria-describedby="projectName-error" onChange={function (e) {
            actions.updateForm({
        ...
        maxLength: {
            ...
            ? "border-brown-50 focus:ring-brown-50 focus:border-brown-50"
            : "border-red-300 text-red-900 placeholder-red-300 focus:outline-none focus:ring-red-500 focus:border-red-500") + " disabled:opacity-50"} placeholder="Matériaux, dimensions, particularités, etc." aria-invalid={!!errors.description} aria-describedby="description-error" onChange={function (e) {
            actions.updateForm({
...
//# sourceMappingURL=quotation-step-description.jsx.map