...
const place_autocomplete_input_1 = require("../place-autocomplete-input/place-autocomplete-input");
const g_tag_1 = require("../../utilities/g-tag");
const QuotationStepShippingLocation = () => {
    const { setValue, trigger, register, handleSubmit, control, formState: { errors }, } = react_hook_form_1.useForm();
    ...
    return (<form onSubmit={handleSubmit(onSubmit)} className="flex-auto h-full flex flex-col">
      <div className="flex-auto pt-16">
            ...
            required: "Vous devez sélectionner un lieu de livraison",
        }} defaultValue={state.form.shippingAddressFormatted} render={({ field: { onChange, onBlur, value } }) => (<place_autocomplete_input_1.default id="shippingAddressFormatted" name="shippingAddressFormatted" defaultValue={value} onChange={e => {
                actions.updateForm({
                ...
                actions.updateForm(placeResult
                    ? {
                        ...
                        shippingAddress: {
                            streetAddress: `${(_c = (_b = (_a = placeResult === null || placeResult === void 0 ? void 0 : placeResult.address_components.filter(c => c.types.includes("street_number"))) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b.long_name) !== null && _c !== void 0 ? _c : ""} ${(_f = (_e = (_d = placeResult === null || placeResult === void 0 ? void 0 : placeResult.address_components.filter(c => c.types.includes("route"))) === null || _d === void 0 ? void 0 : _d[0]) === null || _e === void 0 ? void 0 : _e.long_name) !== null && _f !== void 0 ? _f : ""}`,
                            streetAddressBis: "",
                            postalCode: (_j = (_h = (_g = placeResult === null || placeResult === void 0 ? void 0 : placeResult.address_components.filter(c => c.types.includes("postal_code"))) === null || _g === void 0 ? void 0 : _g[0]) === null || _h === void 0 ? void 0 : _h.long_name) !== null && _j !== void 0 ? _j : "",
                            city: (_m = (_l = (_k = placeResult === null || placeResult === void 0 ? void 0 : placeResult.address_components.filter(c => c.types.includes("locality"))) === null || _k === void 0 ? void 0 : _k[0]) === null || _l === void 0 ? void 0 : _l.long_name) !== null && _m !== void 0 ? _m : "",
                        },
                    }
                    : {
                          ...
                          <div className="rounded-md -space-y-px">
                              <div className="relative py-4 flex">
                                  <div className="flex items-center h-5">
                                      <input id={`shippingAddressProximity`} {...register("shippingAddressProximity")} type="checkbox" className="bg-gris-800 h-8 w-8 text-gris-800 cursor-pointer border-brown-50 focus:ring-opacity-50 focus:ring-brown-50 checked:border-brown-50" defaultChecked={state.form.shippingAddressProximity} onChange={e => {
            actions.updateForm({
