...
const QuotationStepProjectTypology = () => {
    ...
    return (<form onSubmit={handleSubmit(onSubmit)} className="flex-auto h-full flex flex-col">
      <div className="flex-auto pt-16">
        <div className="max-w-4xl mx-auto">
          ...
          <fieldset>
            ...
            <div className="grid sm:grid-cols-3 gap-x-18 mx-auto">
              {state.data.projectTypologies.map((projectTypology, index) => (<div key={projectTypology.code} className="rounded-md -space-y-px">
        ...
        })} type="radio" className="bg-gris-800 h-8 w-8 text-gris-800 cursor-pointer border-brown-50 focus:ring-opacity-50 focus:ring-brown-50 checked:border-brown-50" value={projectTypology.code} defaultChecked={state.form.projectTypologyId === projectTypology.code} onChange={e => actions.updateForm({
