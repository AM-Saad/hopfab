...
import FeaturedImage from "../components/images/architectes/FeaturedImage";
import Illustration1Image from "../components/images/architectes/illustration-1-image";
import Illustration2Image from "../components/images/architectes/illustration-2-image";
import Illustration3Image from "../components/images/architectes/illustration-3-image";
import Illustration4Image from "../components/images/architectes/illustration-4-image";
import Illustration5Image from "../components/images/architectes/illustration-5-image";

import Hopfabcirclewhite from "../components/hopfab-circle_white";
...
import ProjectsList from "../components/projects/architect-projects";
        ...
        <div className="lg:grid lg:grid-cols-12">
          <div className="lg:col-span-12 lg:mx-0 px-6 md:px-8.5 md:mx-0 sm:mx-2">
            <section className="border-b  border-gray-400 flex items-end justify-between mb-6 md:mb-3 pb-3 mt-16">
              ...
              <div>
                <DownRightArrowIcon className="w-9 h-9 md:w-11 md:h-11 lg:w-12 lg:h-12  " />
              </div>
            </section>
            <section className="border-b border-gray-400 lg:grid grid-cols-2 md:pt-15 pb-6">
              <div className="mb-8 md:mb-16 xl:mb-0">
                <h1
                  ...
                  className="text-gray-900 text-2.5xl sm:text-4.25xl md:text-5xl  lg:text-3.8xl xl:text-5xl  md:w-10/12  xl:-tracking-px font-bold sm:mt-10 mb-8 lg:mt-40 md:mb-12 "
                >
                ...
                <AnimatedBtn
                  link="https://lp.hopfab.com/architectes-demande-informations"
                  className="cta mt-6 bg-gris-800 text-center relative overflow-hidden uppercase border-1.5 border-transparent hover:border-gray-400 hover:bg-transparent text-xs rounded-full relative mt-5 px-6 py-2 md:px-7 md:py-3 lg:py-2 lg:px-5 xl:px-4 focus:outline-none focus:ring-4 focus:ring-brown-700 focus:ring-opacity-50 "
                  content="TROUVER UN ARTISAN"
            ...
            <section className="projects-section mb-6 py-3 lg:py-0 md:mb-10">
              ...
              <AnimatedBtn
                link="/realisations"
                className="cta md:hidden group text-center relative overflow-hidden relative overflow-hidden inline-flex items-center uppercase  border-1.5 border-transparent hover:border-gray-400 hover:bg-black font-bold text-xs rounded-full border-1.5 border-gray-400 px-6 py-2 md:px-5 focus:outline-none focus:ring-4 focus:ring-brown-700 focus:ring-opacity-50 my-6 "
                content="TOUS LES PROJETS"
                firstSpan="button-text text-white text-xs "
                secondSpan="button-text text-gray-800 text-xs "
              />
            ...
            <section className="who-you-section  mb-6 md:mb-0 lg-mb-6 py-12">
              <div className="grid grid-cols-1 lg:grid-cols-2 md:gap-x-16 lg:gap-x-21 xl:gap-x-22 2xl:gap-x-31">
                ...
                <div>
                  ...
                  <AnimatedBtn
                    link="/devis"
                    className="cta group text-center ml-18 md:ml-8 relative overflow-hidden relative overflow-hidden inline-flex items-center uppercase  border-1.5 border-transparent hover:border-gray-400 hover:bg-black font-bold text-xs rounded-full border-1.5 border-gray-400 px-6 py-2 md:px-5 focus:outline-none focus:ring-4 focus:ring-brown-700 focus:ring-opacity-50 my-8 "
      ...
      <section className="about-section bg-green-main border-b border-gris-800 p-6 pt-14 md:p-12 md:pt-20 lg:p-16 lg:pt-26">
        ...
        <div>
          <div className=" relative  lg:hidden w-4/12 md:w-2/12 architect-logo-letters">
            <img
              src="/logo-hopfab-square-white.png"
              className="logo-letters architect w-full ml-1 md:ml-0"
              alt="project-1"
            />
            <Hopfabcirclewhite className="hopfab-circle" />
          </div>
          <div></div>
        </div>
        <div className="about-section_content py-8 pt-10">
          <div>
            <p
              className="text-3.8xl md:text-4.8xl lg:text-4.8xl xl:text-6.5xl  lg:w-9/12  xl:w-10/12 text-white font-serif"
              style={{ lineHeight: "1.2" }}
            >
          ...
          <div className="lg:col-span-12 lg:mx-6 md:mx-6 sm:mx-6 mx-6">
            <section className="category border-b border-gray-400 gap-10 lg:grid lg:grid-cols-2 py-7 lg:py-16 justify-items-center">
              ...
              <div>
                <AnimatedBtn
                  link="/realisations"
                  className="cta group text-center relative overflow-hidden relative overflow-hidden inline-flex items-center uppercase  border-1.5 border-transparent hover:border-gray-400 hover:bg-black font-bold text-xs rounded-full border-1.5 border-gray-400 px-6 py-2 md:px-5 focus:outline-none focus:ring-4 focus:ring-brown-700 focus:ring-opacity-50 my-12 lg:my-16 xl:my-26 "
                  content="TOUS LES PROJETS"
                  firstSpan="button-text text-white text-xs "
                  secondSpan="button-text text-gray-800 text-xs "
                />
                <ul>
                  <li
                    onClick={changeCategoryImage}
                    data-name="Residentiel"
                    className=" text-4xl md:text-4.5xl lg:text-4.8xl xl:text-6.1xl text-black lg:text-gris-200 hover:text-black font-bold mb-4 "
                  >
                  ...
                  <li
                    onClick={changeCategoryImage}
                    data-name="Retail"
                    className="active-category-item text-4xl md:text-4.5xl lg:text-4.8xl xl:text-6.1xl text-black lg:text-gris-200 hover:text-black font-bold mb-4 "
                  >
                    <a className="border-b-1.5 border-transparent hover:border-black">
                      Retail
                    </a>{" "}
            ...
            <section className="projects-section border-b border-gray-400 py-16">
              ...
              <div
                className="border border-gray-400 rounded-3xl p-7 lg:px-12 lg:py-6 mb-8 drop-down"
                onClick={openDropBox}
                data-tab="1"
              >
                <div className="flex justify-between items-center drop-down-btn">
                  ...
                  <div className="bg-black p-3 lg:h-9 lg:w-9 rounded-full flex items-center justify-evenly arrow-icon">
                    <UpArrowIcon className="w-3 h-3 text-white  " />
                  </div>
                </div>
              ...
              <div
                className="border border-gray-400 rounded-3xl p-7 lg:px-12 lg:py-6 drop-down"
                onClick={openDropBox}
                data-tab="2"
              >
                <div className="flex justify-between items-center drop-down-btn">
                  ...
                  <div>
                    <div className="space-y-4">
                      <div className="flex flex-wrap text-xs  mb-30 md:mb-48 lg:mb-30 uppercase mt-5 md:mt-0  ">
                        <DownRightArrowIcon className="h-10 w-10 text-gray-100" />
                      </div>
                    ...
                    <div className="">
                      ...
                      <div className="">
                        <AnimatedBtn
                          link="https://lp.hopfab.com/architectes-demande-informations"
                          className="cta group mt-5 md:my-8 bg-gris-800 text-xs text-center relative overflow-hidden relative overflow-hidden inline-flex items-center uppercase   hover:bg-white text-xs rounded-full  px-5 py-2 md:px-5 xl:px-6  focus:outline-none focus:ring-4 focus:ring-brown-700 focus:ring-opacity-50"
                          content="TROUVER UN ARTISAN"
                          firstSpan="button-text text-gray-800"
                          secondSpan="button-text text-white "
                        />
                      </div>
                    </div>
                  </div>
