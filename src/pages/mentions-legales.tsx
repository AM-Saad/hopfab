...
const MentionsLegalesPage: React.FC<PageProps<DataProps>> = () => {
  const [currentTab, setCurrentTab] = useState("tab-acheteur");
    ...
    <DefaultLayout>
      ...
      <div className="sm:flex sm:flex-col sm:align-center">
        <div className="relative self-center mt-6 bg-gray-100 rounded-lg p-0.5 flex sm:mt-8">
          <button
            id="button-tab-acheteur"
            type="button"
            onClick={() => setCurrentTab("tab-acheteur")}
            className={`relative w-1/2 rounded-md py-2 text-sm font-medium text-gray-700 focus:outline-none focus:ring-2 focus:ring-brown-700 focus:z-10 sm:w-auto sm:px-8 ${
              currentTab === "tab-acheteur"
                ? "bg-brown-700 text-brown-50 border-gray-200"
                : "border border-transparent"
            }`}
            aria-controls="tab-acheteur"
            role="tab"
            aria-selected={currentTab === "tab-acheteur"}
          >
            Conditions d'utilisation acheteur
          </button>
          <button
            id="button-tab-intermediaire"
            type="button"
            onClick={() => setCurrentTab("tab-intermediaire")}
            className={`ml-0.5 relative w-1/2 rounded-md py-2 text-sm font-medium text-gray-700 focus:outline-none focus:ring-2 focus:ring-brown-700 focus:z-10 sm:w-auto sm:px-8 ${
              currentTab === "tab-intermediaire"
                ? "bg-brown-700 text-brown-50 border-gray-200"
                : "border border-transparent"
            }`}
            aria-controls="tab-intermediaire"
            role="tab"
            aria-selected={currentTab === "tab-intermediaire"}
          >
      ...
      <section className="my-12">
        <div
          ...
          className={`max-w-3xl m-auto ${
            currentTab === "tab-acheteur" ? "" : "hidden"
          }`}
          aria-labelledby="button-tab-acheteur"
          role="tabpanel"
        >
        ...
        <div
          id="tab-intermediaire"
          className={`max-w-3xl m-auto ${
            currentTab === "tab-intermediaire" ? "" : "hidden"
          }`}
          aria-labelledby="button-tab-intermediaire"
          role="tabpanel"
        >
          <div className="text-center mb-4">Mises à jour le 10 avril 2020</div>
