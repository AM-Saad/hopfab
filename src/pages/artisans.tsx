...
import FeaturedImage from "../components/images/artisans/FeaturedImage";
...
import Testimonials from "../components/testimonials/testimonials-artisan";
...
const IndexPage: React.FC<PageProps<DataProps>> = ({}) => {
  ...
  const changeCategoryImage = e => {
    ...
    document.querySelectorAll("div[data-name]").forEach(e => {
  ...
  return (
    <BaseLayout>
          ...
          <div className="lg:col-span-12 lg:mx-0 px-6 md:px-8.5 md:mx-0 sm:mx-2">
            ...
            <section className="border-b border-gray-400 lg:grid grid-cols-2 md:pt-15 pb-6">
              <div className="mb-8 md:mb-16 xl:mb-0">
                ...
                >
                  <span className="text-darkgreen"> Accédez</span> à des projets
                  d’architectes d’intérieur et{" "}
                  <span className="text-darkgreen"> collaborez</span> en direct.
                </h1>
                <AnimatedBtn
                  link="https://lp.hopfab.com/fr/rejoindre-le-r%C3%A9seau-dartisans-hopfab"
                ...
                <div>
                  <div className="mb-8 md:mb-16">
                    ...
                    <p className="text-lg md:text-xl lg:text-xl xl:text-2xl md:w-9/12 lg:w-full text-gray-700 ml-18 md:ml-8">
                      ...
                      <br /> Libre à vous de les accepter ou de les refuser.
                    </p>
                  </div>
                  <div className="mb-8 md:mb-16">
                    <div className="flex items-start ">
      ...
      <section className="about-section bg-green-main  p-6 pt-14 md:p-12 md:pt-20 lg:p-16 lg:pt-26">
      ...
      <div className="min-w-screen-lg lg:px-5 mx-auto">
        <div className="lg:grid lg:grid-cols-12">
          <div className="lg:col-span-12 lg:mx-6 md:mx-6 sm:mx-6 mx-6">
            ...
            <section className=" mb-6 pt-3 md:pb-16 relative artisan">
          ...
          <div className="lg:grid lg:grid-cols-13 pb-14 md:pb-48  lg:pb-30">
            <section className="lg:col-span-11 ">
              <article className={` pt-16`}>
                <div className="lg:space-y-30 space-y-10 md:w-11/12 lg:space-y-30">
                  <div>
