            ...
            <section className="border-b border-gray-400 lg:grid grid-cols-2 md:pt-15 pb-6">
              <div className="mb-8 md:mb-16 xl:mb-0">
                <h1
                  ...
                  className="text-gray-900 text-2.5xl sm:text-4.25xl md:text-5xl  lg:text-3.8xl xl:text-5xl      md:w-10/12  xl:-tracking-px font-bold sm:mt-10 mb-8 lg:mt-52 md:mb-16 "
                >
